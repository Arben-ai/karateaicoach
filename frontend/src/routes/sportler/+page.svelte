...
<!-- ── SEKTION 2: Übersicht (nur Admin) ── -->
{#if isAdmin}
<section class="sp-list-section">
  <div class="page-content">
          ...
          <div class="col">
            <div class="sportler-card">
              ...
              <div class="sportler-card-top">
                <div class="sportler-avatar">{s.name.charAt(0).toUpperCase()}</div>
...
<!-- Delete Modal (position:fixed, ausserhalb der Sektionen) -->
{#if deleteTarget}
